...
CREATE TABLE IF NOT EXISTS `operator` (
  ...
  `level` enum('admin','dokter','operator') NOT NULL,
...
INSERT INTO `operator` (`operator_id`, `nama_lengkap`, `username`, `password`, `level`, `last_login`) VALUES
(1, 'admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', '2014-07-24'),
(2, 'dokter', 'dokter', 'd22af4180eee4bd95072eb90f94930e5', 'dokter', '2014-07-17'),
(4, 'operator', 'operator', '4b583376b2767b923c3e1da60d10de59', 'operator', '2015-12-31');
